...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)(__assign({ class: ((['btn', { 'btn-small': __VLS_ctx.small, 'btn-icon': __VLS_ctx.icon }])) }));
    var __VLS_0 = {};
