...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.main, __VLS_intrinsicElements.main)(__assign({ class: ("main") }, { ref: ("app") }));
    // @ts-ignore navigation for `const app = ref()`
    __VLS_ctx.app;
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: ("page") }));
    var __VLS_0 = {};
