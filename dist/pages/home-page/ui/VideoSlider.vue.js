...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ navigation: (({ nextEl: '.custom-next', prevEl: '.custom-prev' })), modules: (([__VLS_ctx.Navigation])), loop: ((true)), ...{ class: ("mySwiper") }, }));
    const __VLS_2 = __VLS_1({ navigation: (({ nextEl: '.custom-next', prevEl: '.custom-prev' })), modules: (([__VLS_ctx.Navigation])), loop: ((true)), ...{ class: ("mySwiper") }, }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    for (const [video] of __VLS_getVForSourceType((props.videos))) {
        ...
        // @ts-ignore
        const __VLS_7 = __VLS_asFunctionalComponent(__VLS_6, new __VLS_6({ ...{ style: ({}) }, }));
        const __VLS_8 = __VLS_7({ ...{ style: ({}) }, }, ...__VLS_functionalComponentArgsRest(__VLS_7));
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({ ...{ class: ("custom-prev") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({ ...{ class: ("custom-next") }, });
