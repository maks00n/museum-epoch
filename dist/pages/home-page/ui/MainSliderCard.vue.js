...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("main-slider-card") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.img, __VLS_intrinsicElements.img)({ src: ((props.photo)), alt: ("photo"), ...{ style: ((__VLS_ctx.isCompact ? { height: '279rem' } : { height: '486rem' })) }, });
